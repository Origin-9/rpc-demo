 ...
 * @Description:
 * @Author: ori
 * @Date: Created in 2019-12-23 16:08
 */
public final class ReferenceUtil {

    private static Map<String, ReferenceConfig> referenceConfigMap = new HashMap<String, ReferenceConfig>();
